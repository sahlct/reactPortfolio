  ...
  return (
    <>
      <div className="w-full min-h-screen pt-[50px] flex bg-[#1d0e2f] ps-20 relative">
        <div className="GradiantRound w-[100px] h-[100px] bg-blue-800 rounded-full shadow-2xl shadow-white"></div>
        ...
        <div className="flex flex-col items-start leading-tight">
          ...
          <h1 className="text-[50px] font-bold">Mern Stack Developer +</h1>
          <h1 className="text-[50px] font-bold">Web Designer</h1>
          </div>
          <p>
            ...
            molestiae rerum repellendus doloremque, expedita alias iste aliquid
            quibusdam earum excepturi atque odio vitae distinctio repudiandae
            qui veniam quo id, numquam deleniti sunt suscipit cum!
          </p>
